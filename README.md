...
* **ANALISTA\_CQ:** Perfil destinado à verificação de qualidade (funcionalidade futura).
...
| **EM EXECUÇÃO** | Amarelo          | O técnico está trabalhando ativamente no chamado. | `Finalizar Execução` (🛠️) |
...
Abaixo está um exemplo da tela para criação de uma OS:

![Tela Criar OS](./assets/criar%20os.png)

---

### 🔄 Fluxograma da Ordem de Serviço

O fluxograma abaixo ilustra o ciclo de vida de uma OS no sistema. Clique na imagem para abrir a versão interativa no Miro:

[![Abrir Fluxograma no Miro](./assets/fluxograma-os.png)](https://miro.com/app/board/uXjVJeS2vIM=/?moveToWidget=3458764634555012141&cot=14)
